...
void synch(Production prod, MachineResult *tok, ParserData *parser_data)
{
	...
	case PRODUCTION_SIMPLE_EXPR_:
		synchSet = (TokenType[]){TOKEN_EOF, TOKEN_THEN, TOKEN_COMMA, TOKEN_SEMICOLON, TOKEN_RBRACKET, TOKEN_DO, TOKEN_ELSE, TOKEN_RPAREN, TOKEN_RELOP, TOKEN_END}; len = 10;
	break;
	case PRODUCTION_TERM:
	case PRODUCTION_TERM_:
		synchSet = (TokenType[]){TOKEN_EOF, TOKEN_THEN, TOKEN_COMMA, TOKEN_SEMICOLON, TOKEN_ADDOP, TOKEN_RBRACKET, TOKEN_DO, TOKEN_ELSE, TOKEN_RPAREN, TOKEN_RELOP, TOKEN_END}; len = 11;
	break;
	case PRODUCTION_FACTOR:
	case PRODUCTION_FACTOR_:
		synchSet = (TokenType[]){TOKEN_EOF, TOKEN_THEN, TOKEN_COMMA, TOKEN_SEMICOLON, TOKEN_ADDOP, TOKEN_DO, TOKEN_RPAREN, TOKEN_ELSE, TOKEN_RELOP, TOKEN_MULOP, TOKEN_RBRACKET, TOKEN_END}; len = 12;
	break;
